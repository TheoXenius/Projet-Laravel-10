...
<section>
    ...
    <form action="{{ route('main.reservation.store')}}" method="post">
        ...
        <div>
            ...
            <input type="number" name="couverts" id="couverts" value="{{ old('couverts')}}" not-required>
            @error('couverts')
            <div class="invalid-feedback">{{ $message}}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <textarea name="commentaire" id="commentaire" cols="30" rows="10" value="{{ old('commentaire')}}"></textarea>
            @error('commentaire')
            <div class="invalid-feedback">{{ $message}}</div>
            @enderror
        </div>
